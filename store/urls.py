...
urlpatterns = [
    ...
    path('update/<int:pk>/', views.ClothesUpdateView.as_view(), name='update_clothes'),
    path('delete-clothes/<int:pk>/', views.ClothesDeleteView.as_view(), name='delete_clothes'),
    path('administration/', views.get_all_products_administration, name='product_administration')
]
